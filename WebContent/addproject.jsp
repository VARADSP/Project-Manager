	...
	<header>
		<nav class="navbar sticky-top navbar-dark bg-primary">
			<div class="container-fluid">
				...
				<form class="d-flex">
					<a class="btn btn-outline-info mx-3" href="showAdmin">Back</a> 
	...
	<main>
		<div class="container mx-auto my-5 w-50"
			...
			<div class="row">
				...
				<form action="addProject" id="projectaddin" method="POST">
					<div class="form-group col-6 mx-auto">
						<label for="exampleInputEmail1">Project Name</label> <input
							...
							placeholder="Enter Project Name"> <small></small>
					</div>
					<div class="form-group my-3 col-6 mx-auto">
						<label for="exampleInputPassword1">Project Location</label> <input
							...
							placeholder="Enter Project Location" name="projectlocation"> <small></small>
					</div>
					<div class="form-group my-3 col-6 mx-auto">
